document.addEventListener('DOMContentLoaded', () => {
  ...
  // 【追加】そもそも画面にお知らせリストもページネーション領域もない場合は、
  // 後続の処理（API通信やイベント登録）を一切行わずに安全に終了する。
  if (!announcementsList && !paginationContainer) {
    return;
  }
  ...
  // 【修正】paginationContainer が存在する場合のみイベントリスナーを登録する
